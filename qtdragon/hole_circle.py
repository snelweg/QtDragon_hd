...
class Hole_Circle(QtWidgets.QWidget):
    def __init__(self, parent=None):
        ...
        self.filename = os.path.join(os.getcwd(), 'qtdragon/hole_circle.ui')
        try:
        ...
        if os.path.isfile("qtdragon/hole_circle_help.txt"):
            help_file = open("qtdragon/hole_circle_help.txt", "r")
