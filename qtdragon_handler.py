...
#                    QtCore.Qt.Key_F3,QtCore.Qt.Key_F4,QtCore.Qt.Key_F5):
    ...
    def metric_mode_changed(self, mode):
        ...
        self.w.lbl_maxv_units.setText(unit + "/MIN")
        self.w.lbl_max_rapid_units.setText(unit + "/MIN")
        self.w.lbl_feed_units.setText(unit + "/MIN")
    ...
    def chk_enable_spindle_changed(self, state):
        text = "SPINDLE ENABLED" if state else "SPINDLE DISABLED"
        self.w.chk_enable_spindle.setText(text)
        self.w.action_spindle_fwd.setEnabled(state)
        self.w.action_spindle_rev.setEnabled(state)
